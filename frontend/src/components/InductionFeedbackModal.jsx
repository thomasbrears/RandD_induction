...
const InductionFeedbackModal = ({ visible, onClose, inductionId }) => {
  ...
  useEffect(() => {
    ...
    // Set up a form values change listener
    const unregister = form.getFieldsValue;
    form.setFields = (...args) => {
      unregister(...args);
      checkFormValidity();
    };
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast.success('Thank you for your feedback! It helps us improve our induction process.', {
        position: "top-right",
        autoClose: 4000,
  ...
  return (
    <Modal
      title={<Title level={4} className="mb-0">Induction Feedback</Title>}
      open={visible}
      width={600}
      onCancel={onClose}
      footer={[
      ...
      <Space direction="vertical" size="large" className="w-full">
        <div>
          <Text className="text-gray-600">
            Your feedback helps us improve the induction process for future users.
          </Text>
        </div>
